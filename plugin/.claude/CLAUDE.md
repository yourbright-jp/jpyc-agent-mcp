...
Use this guidance when operating JPYC Agent MCP through Claude Code.
...
- Do not use this guidance for unrelated Web3 tooling outside the JPYC Agent MCP endpoint.
